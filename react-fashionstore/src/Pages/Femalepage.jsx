...
import posture from '../img/posture_female.png';
import female from '../img/femaleimg.jpg';
import female1 from '../img/femaleimg1.jpg';
import female2 from '../img/femaleimg2.jpg';
import female3 from '../img/femaleimg3.jpg';
...
function Femalepage()
{
    return(
        <div className="body">
                <div className="nav1">
                    ...
                    <Link className="logo1" to="#"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" fill="currentColor" className="bi bi-heart-fill nav2" viewBox="0 0 16 16" >
                    <path fill-rule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314" />
                    </svg></Link>
                    <Link to="#" className="logo1" ><svg xmlns="http://www.w3.org/2000/svg" width="25" height="30" fill="currentColor" className="bi bi-person-circle nav2" viewBox="0 0 16 16">
    ...
    <img src={posture} class="poster_img " alt="femaleimg"/> 
    </div>
    <div class="container2"> Discover the latest trends in women's fashion – chic, stylish, and made just for you.</div>
