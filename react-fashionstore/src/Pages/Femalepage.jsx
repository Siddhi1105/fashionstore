...
function Femalepage() {
  return (
    <div className="body">
      ...
      <div className="nav2">
        ...
        <li className="nav-item dropdown">
          ...
          <ul className="dropdown-menu">
            <li><Link className="dropdown-item" to="/topwear">All Topwears</Link></li>
        ...
        <Link to="like.html" className="icon1">
        ...
        <Link to="Account.html" className="icon1">
      ...
      <div>
        <img src={posture} className="poster_img" alt="femaleimg" />
      </div>
      <div className="container2"> Discover the latest trends in women's fashion – chic, stylish, and made just for you.</div>
