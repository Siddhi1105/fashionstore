...
function Kids() {
      ...
      <div className="nav1">
        ...
        <div className="nav2">     
           ...
           <li className="nav-item dropdown">
            ...
            <Link to="/Likes" className="icon1"><svg   xmlns="http://www.w3.org/2000/svg" width="15" height="25" fill="currentColor" class="bi bi-heart-fill nav2" viewBox="0 0 16 16" >
    ...
    <div className="main_page_img" alt="kidimg">
        {/* <div className="box"/>
        <img src={kid1} className="img_size"/>
